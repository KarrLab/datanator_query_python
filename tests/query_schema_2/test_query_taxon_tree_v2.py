...
class TestQTaxon(unittest.TestCase):
    ...
    def test_aggregate_distance(self):
        ...
        target_0 = 0
        target_1 = 1227178
        result_0 = self.src.aggregate_distance(measured_0, target_0, name_field='tax_name')
        self.assertEqual(result_0, measured_0)
        result_1 = self.src.aggregate_distance(measured_0, target_1, name_field='tax_name')
        ...
        result_2 = self.src.aggregate_distance(measured_1, target_2, name_field='tax_name')
