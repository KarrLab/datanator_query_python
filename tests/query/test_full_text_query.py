...
class TestFTX(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.index_0 = 'test_0'
        cls.index_1 = 'test_1'
        cls.url_0 = cls.src.ftx_manager.es_endpoint + '/' + cls.index_0
        cls.url_1 = cls.src.ftx_manager.es_endpoint + '/' + cls.index_1
    ...
    def tearDownClass(cls):
        ...
        requests.delete(cls.url_0, auth=cls.src.ftx_manager.awsauth)
        requests.delete(cls.url_1, auth=cls.src.ftx_manager.awsauth)

    def test_request_body_search(self):
        query_0 = 'mock_value_3'
        field_0 = ['mock_key_bulk', 'number']
        body_0 = self.src.ftx_manager.build_simple_query_string_body(query_0, fields=field_0, lenient=True,
        analyze_wild_card=True)
        index_0 = 'test_0,test_1'
        es = self.src.ftx_manager._build_es()
